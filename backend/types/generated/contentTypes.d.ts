...
export interface ApiFeatureCardFeatureCard extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Homepage feature/benefit cards';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::feature-card.feature-card'> &
      Schema.Attribute.Private;
...
export interface ApiHeroSectionHeroSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    headline: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Welcome to EcommerceStore'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    secondaryButtonLink: Schema.Attribute.String & Schema.Attribute.DefaultTo<'/categories'>;
    secondaryButtonText: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Browse Categories'>;
    subtitle: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Discover amazing products at unbeatable prices. Shop the latest trends and must-have items.'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}

export interface ApiNavigationLinkNavigationLink extends Struct.CollectionTypeSchema {
  collectionName: 'navigation_links';
  info: {
    description: 'Additional navigation links for header/footer';
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::site-setting.site-setting'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    searchPlaceholder: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Search products...'>;
    siteLogo: Schema.Attribute.String & Schema.Attribute.DefaultTo<'\uD83D\uDECD\uFE0F'>;
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'EcommerceStore'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
export interface ApiThemeSettingThemeSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Color palette and theme configuration';
  ...
  attributes: {
    ...
    borderColor: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<'plugin::color-picker.color'> &
      Schema.Attribute.DefaultTo<'#e5e5e5'>;
    ...
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    destructiveColor: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<'plugin::color-picker.color'> &
      Schema.Attribute.DefaultTo<'#ef4444'>;
    destructiveForeground: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<'plugin::color-picker.color'> &
      Schema.Attribute.DefaultTo<'#fafafa'>;
    foregroundColor: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<'plugin::color-picker.color'> &
      Schema.Attribute.DefaultTo<'#171717'>;
    inputColor: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<'plugin::color-picker.color'> &
      Schema.Attribute.DefaultTo<'#e5e5e5'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::theme-setting.theme-setting'> &
      Schema.Attribute.Private;
    mutedColor: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<'plugin::color-picker.color'> &
      Schema.Attribute.DefaultTo<'#f5f5f5'>;
    mutedForeground: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<'plugin::color-picker.color'> &
      Schema.Attribute.DefaultTo<'#737373'>;
    ...
    primaryForeground: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'#fafafa'>;
    publishedAt: Schema.Attribute.DateTime;
    ringColor: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<'plugin::color-picker.color'> &
      Schema.Attribute.DefaultTo<'#171717'>;
    ...
    themeName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Default Theme'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
